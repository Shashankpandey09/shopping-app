  ...
  return (
    <div className="bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 shadow-lg h-20 p-4 z-10 w-screen fixed flex justify-between items-center">
      <div className="flex items-center cursor-pointer text-gray-800">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="rgba(0,0,0,0.5)" onClick={openSideBars}>
        ...
        <form onSubmit={handleSubmit} className="flex items-center justify-between w-full">
          ...
          <button type="submit">
            <svg
              ...
              viewBox="0 0 24 24"
              className="mr-2 cursor-pointer z-10 hover:scale-105 text-gray-500"
              width="28"
              height="28"
              fill="currentColor"
            >
      ...
      <div className="shopping-svg text-gray-800 flex gap-2 relative">
        <Link to="/Cart">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" fill="rgba(0,0,0,0.5)">
